...
export function useActors() {
    ...
    const loadRecords = useCallback(()=>{
        apiClient.get('/actors', {params: {page,recordsPerPage}})
            .then(res => {
    ...
    return {handleChildButtonClick, loading, page,recordsPerPage, totalAmountOfRecords,setPage,setRecordsPerPage,actors, loadRecords};
}